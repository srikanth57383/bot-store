                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">FOREX APPLICATION FORM</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <input class="form-control" type="text" placeholder="" id="firstname"
                                                maxlength="11" minlength="2" name="Branchcode" Required>
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <input class="form-control" type="number" placeholder="" id="firstname"
                                                maxlength="12" name="CardNumber" required
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <input class="form-control" type="text" placeholder="" id="lastname"
                                                onkeydown="return /[a-z\s]/i.test(event.key)" maxlength="150"
                                                name="MothersName" Required>
                                        </div>
                                        <div class="mb-3 col-lg-6">
                                            <label for="firstname" class="form-label">Account Balance<span
                                                    class='text-danger'>*</span></label>
                                            <input class="form-control" type="number" placeholder="" id=""
                                                maxlength="12" name="account_balance" required
                                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                        ...
                                        <div class="mb-3 col-lg-4">
                                            ...
                                            <input type="radio" name="status" value="Married" checked Required> Married
                                            /
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <label for="lastname" class="form-label">Email Id <span
                                                    class='text-danger'>*</span></label>
                                            <input class="form-control" type="email" placeholder="" id="lastname"
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <select class="form-select" name="ForeignCurrency" required 
                                                ...
                                                <option value="" disabled selected>Choose From Currency</option>
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <select class="form-select" name="tocurrency" required  id="toCurrency">
                                                <option value="" disabled selected>Choose To Currency</option>
                                                <option value="USD">USD</option>
                                                <option value="EUR">EUR</option>
                                                <option value="GBP">GBP</option>
                                                <option value="AUD">AUD</option>
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="number" placeholder=""
                                                    id="amountToBeLoaded" name="AmoutToBebeLoaded" maxlength="16"
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <div class="mb-3 col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="number" placeholder=""
                                                        id="totalafterdeduction" name="total_amount" Required>
                                                </div>
                                            ...
                                            <div class="mb-3 col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="number" placeholder=""
                                                        id="amountLoaded" name="AmoutLoaded" Required>
                                                </div>
                                            </div>
...
$('#fromCurrency, #toCurrency,#amountToBeLoaded').change(function() {
    ...
    if (fromCurrency && toCurrency && amountToBeLoaded) {
        if (fromCurrency !== toCurrency) {
            ...
            fetch("https://api.apilayer.com/currency_data/live?source=" + fromCurrency + "&currencies=" +
                ...
                .then(result => {
                    ...
                    $('#amountLoaded').val((result.quotes[key] * amountToBeLoaded).toFixed(2))
                })
