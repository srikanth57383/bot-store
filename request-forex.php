                            ...
                            <div class="card-body">
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    <thead>
                                        ...
                                        <th>Total Amount After Deduction</th>
                                        <th>Status</th>
                                        <th>Update</th>
                                        <!-- <th>Delete</th>
                                        <th>view</th> -->
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = "SELECT * FROM `forex` WHERE `forex_applied`='yes' ";
                                            ...
                                            // output data of each row
                                                while($row = $result->fetch_assoc()) {
                                                    ...
                                                    if($row["active"]==='Inactive'){
                                                        echo "<td>"."<button id='updateForex' class='btn btn-info' data-id='".$row['id']."' data-status='".$row['active']."'>Active</a>"."</td>\n";
                                                    }else{
                                                        echo "<td>"."<button id='updateForex' class='btn btn-danger' data-id='".$row['id']."' data-status='".$row['active']."'>Inactive</a>"."</td>\n";
                                                    }
...
$("#datatable-buttons").on("click", "#updateForex", function() {
