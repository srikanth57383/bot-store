        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                <li>
                    <a href="forex.php">
                        <i data-feather=""></i>
                        <span data-key="t-dashboard">Forex Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="existing-emp-data.php">
                        <i data-feather="forex.php"></i>
                        <span data-key="t-dashboard">Existing Customer data
                        </span>
                    </a>
                </li>
                <li>
                    <a href="request-forex.php">
                        <i data-feather=""></i>
                        <span data-key="t-dashboard">Requested for Forex
                        </span>
                    </a>
                </li>
